<template>
  <div class="cal-wrapper">
    <div class="cal-header">
      <div class="l" @click="preMonth"><div class="button-left-bg"><p class="arrow-left icon"></p></div></div>
      <div class="title">{{curYearMonth}}</div>
      <div class="r" @click="nextMonth"><div class="button-right-bg"><p class="arrow-right icon"></p></div></div>
    </div>
    <div class="cal-body">
      <div class="weeks">
        <span
      ...
      <div class="dates" >
        <div v-for="date in dayList" class="item"
          ...
          <p class="date-num"
            ...
            :style="{color: date.title != undefined ? ((date.date == selectedDay) ? '#fff' : customTextColor) : 'inherit'}">
...
export default {
  ...
  computed: {
    ...
    customTextColor () {
      return this.calendar.options.textColor
    }
  },
  methods: {
    nextMonth () {
